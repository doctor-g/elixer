...
walker.currentNode=parent;for(var n=walker.firstChild(),_i3=0;n;n=walker.nextSibling()){if(nodeInfo.parentIndex===_i3++){return n}}}else{return root}}// construct `$` map (from id annotations)
...
// (again same as 1.x)
function applyBehaviors(proto,behaviors,lifecycle){for(var _i48=0;_i48<behaviors.length;_i48++){applyInfo(proto,behaviors[_i48],lifecycle,excludeOnBehaviors)}}function applyInfo(proto,info,lifecycle,excludeProps){copyProperties(info,proto,excludeProps);for(var _p14 in lifecycleProps){if(info[_p14]){lifecycle[_p14]=lifecycle[_p14]||[];lifecycle[_p14].push(info[_p14])}}}/**
...
var behaviorList,lifecycle={},PolymerGenerated=/*#__PURE__*/function(_Base){babelHelpers.inherits(PolymerGenerated,_Base);function PolymerGenerated(){babelHelpers.classCallCheck(this,PolymerGenerated);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PolymerGenerated).apply(this,arguments))}babelHelpers.createClass(PolymerGenerated,[{key:"created",/**
       * @return {void}
       */value:function created(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"created",this).call(this);var list=lifecycle.created;if(list){for(var _i50=0;_i50<list.length;_i50++){list[_i50].call(this)}}}/**
       * @return {void}
...
var _proto=Object.getPrototypeOf(this),list=lifecycle.beforeRegister;if(list){for(var _i51=0;_i51<list.length;_i51++){list[_i51].call(_proto)}}list=lifecycle.registered;if(list){for(var _i52=0;_i52<list.length;_i52++){list[_i52].call(_proto)}}}}/**
       * @return {void}
       */},{key:"_applyListeners",value:function _applyListeners(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"_applyListeners",this).call(this);var list=lifecycle.listeners;if(list){for(var _i53=0,listeners;_i53<list.length;_i53++){listeners=list[_i53];if(listeners){for(var l in listeners){this._addMethodEventListenerToNode(this,l,listeners[l])}}}}}// note: exception to "super then me" rule;
// do work before calling super so that super attributes
// only apply if not already set.
/**
     * @return {void}
     */},{key:"_ensureAttributes",value:function _ensureAttributes(){var list=lifecycle.hostAttributes;if(list){for(var _i54=list.length-1,hostAttributes;0<=_i54;_i54--){hostAttributes=list[_i54];for(var a in hostAttributes){this._ensureAttribute(a,hostAttributes[a])}}}babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"_ensureAttributes",this).call(this)}/**
       * @return {void}
       */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"ready",this).call(this);var list=lifecycle.ready;if(list){for(var _i55=0;_i55<list.length;_i55++){list[_i55].call(this)}}}/**
       * @return {void}
       */},{key:"attached",value:function attached(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"attached",this).call(this);var list=lifecycle.attached;if(list){for(var _i56=0;_i56<list.length;_i56++){list[_i56].call(this)}}}/**
       * @return {void}
       */},{key:"detached",value:function detached(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"detached",this).call(this);var list=lifecycle.detached;if(list){for(var _i57=0;_i57<list.length;_i57++){list[_i57].call(this)}}}/**
       * Implements native Custom Elements `attributeChangedCallback` to
       * set an attribute value to a property via `_attributeToProperty`.
       *
       * @param {string} name Name of attribute that changed
       ...
       * @param {?string} value New attribute value
       * @return {void}
       */},{key:"attributeChanged",value:function attributeChanged(name,old,value){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"attributeChanged",this).call(this);var list=lifecycle.attributeChanged;if(list){for(var _i58=0;_i58<list.length;_i58++){list[_i58].call(this,name,old,value)}}}}],[{key:"_finalizeClass",// explicitly not calling super._finalizeClass
...
if(behaviorList){for(var _i59=0,b;_i59<behaviorList.length;_i59++){b=behaviorList[_i59];if(b.properties){this.createProperties(b.properties)}if(b.observers){this.createObservers(b.observers,b.properties)}}}if(info.properties){this.createProperties(info.properties)}if(info.observers){this.createObservers(info.observers,info.properties)}// make sure to prepare the element template
this._prepareTemplate()}}},{key:"properties",get:function get(){var properties={};if(behaviorList){for(var _i60=0;_i60<behaviorList.length;_i60++){mergeProperties(properties,behaviorList[_i60].properties)}}mergeProperties(properties,info.properties);return properties}},{key:"observers",get:function get(){var observers=[];if(behaviorList){for(var _i61=0,b;_i61<behaviorList.length;_i61++){b=behaviorList[_i61];if(b.observers){observers=observers.concat(b.observers)}}}if(info.observers){observers=observers.concat(info.observers)}return observers}}]);return PolymerGenerated}(Base);// apply behaviors, note actual copying is done lazily at first instance creation
...
var templateHost=this.__dataHost.__dataHost;if(templateHost){templateHost._addEventListenerToNode(node,eventName,handler)}}}/**
     ...
     * @return {void}
     * @protected
     */},{key:"_showHideChildren",value:function _showHideChildren(hide){for(var c=this.children,_i62=0,n;_i62<c.length;_i62++){n=c[_i62];// Ignore non-changes
...
this.mutableData=!0}/**
     ...
     * @override
     * @return {void}
     */},{key:"disconnectedCallback",value:function disconnectedCallback(){this.__removeChildren()}},{key:"__insertChildren",value:function __insertChildren(){wrap$1(wrap$1(this).parentNode).insertBefore(this.root,this)}},{key:"__removeChildren",value:function __removeChildren(){if(this.__children){for(var _i63=0;_i63<this.__children.length;_i63++){this.root.appendChild(this.__children[_i63])}}}/**
...
get:function get(){return"dom-repeat"}},{key:"template",get:function get(){return null}},{key:"properties",get:function get(){/**
     ...
     * @override
     * @return {void}
     */babelHelpers.createClass(DomRepeat,[{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(DomRepeat.prototype),"disconnectedCallback",this).call(this);this.__isDetached=!0;for(var _i64=0;_i64<this.__instances.length;_i64++){this.__detachInstance(_i64)}}/**
     * @override
     * @return {void}
...
if(this.__isDetached){this.__isDetached=!1;for(var wrappedParent=wrap$1(wrap$1(this).parentNode),_i65=0;_i65<this.__instances.length;_i65++){this.__attachInstance(_i65,wrappedParent)}}}},{key:"__ensureTemplatized",value:function __ensureTemplatized(){var _this23=this;// Templatizing (generating the instance constructor) needs to wait
...
var instanceProps={};instanceProps[this.as]=!0;instanceProps[this.indexAs]=!0;instanceProps[this.itemsIndexAs]=!0;this.__ctor=_templatize(_template3,this,{mutableData:this.mutableData,parentModel:!0,instanceProps:instanceProps,/**
         ...
         */forwardHostProp:function forwardHostProp(prop,value){for(var i$=this.__instances,_i66=0,inst;_i66<i$.length&&(inst=i$[_i66]);_i66++){inst.forwardHostProp(prop,value)}},/**
         * @this {DomRepeat}
...
for(var paths=this.__observePaths,_i67=0;_i67<paths.length;_i67++){if(0===path.indexOf(paths[_i67])){this.__debounceRender(this.__render,this.delay)}}}}}/**
...
this.__tryRenderChunk()}},{key:"__applyFullRefresh",value:function __applyFullRefresh(){for(var _this25=this,items=this.items||[],isntIdxToItemsIdx=Array(items.length),_i68=0;_i68<items.length;_i68++){isntIdxToItemsIdx[_i68]=_i68}// Apply user filter
...
for(var _i69=this.__instances.length-1;_i69>=instIdx;_i69--){this.__detachAndRemoveInstance(_i69)}}},{key:"__detachInstance",value:function __detachInstance(idx){for(var inst=this.__instances[idx],wrappedRoot=wrap$1(inst.root),_i70=0,el;_i70<inst.children.length;_i70++){el=inst.children[_i70];wrappedRoot.appendChild(el)}return inst}},{key:"__attachInstance",value:function __attachInstance(idx,parent){var inst=this.__instances[idx];// Note, this is pre-wrapped as an optimization
...
/**
   ...
   * @return {void}
   * @protected
   */},{key:"_showHideChildren",value:function _showHideChildren(hidden){for(var _i71=0;_i71<this.__instances.length;_i71++){this.__instances[_i71]._showHideChildren(hidden)}}// Called as a side effect of a host items.<key>.<path> path change,
...
for(var _this30=this,selected=this.__selectedMap,_loop4=function _loop4(_i74){var s=splices[_i74];selected.forEach(function(idx,item){if(idx<s.index){// no change
}else if(idx>=s.index+s.removed.length){// adjust index
selected.set(item,idx+s.addedCount-s.removed.length)}else{// remove index
selected.set(item,-1)}});for(var j=0,idx;j<s.addedCount;j++){idx=s.index+j;if(selected.has(_this30.items[idx])){selected.set(_this30.items[idx],idx)}}},_i74=0;_i74<splices.length;_i74++){_loop4(_i74)}// Update linked paths
...
this.waveContainer.style.webkitTransform="translate("+dx+"px, "+dy+"px)";this.waveContainer.style.transform="translate3d("+dx+"px, "+dy+"px, 0)";this.wave.style.webkitTransform="scale("+scale+","+scale+")";this.wave.style.transform="scale3d("+scale+","+scale+",1)"},/** @param {Event=} event */downAction:function downAction(event){var xCenter=this.containerMetrics.width/2,yCenter=this.containerMetrics.height/2;this.resetInteractionState();this.mouseDownStart=Utility.now();if(this.center){this.xStart=xCenter;this.yStart=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}else{this.xStart=event?event.detail.x-this.containerMetrics.boundingRect.left:this.containerMetrics.width/2;this.yStart=event?event.detail.y-this.containerMetrics.boundingRect.top:this.containerMetrics.height/2}if(this.recenters){this.xEnd=xCenter;this.yEnd=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}this.maxRadius=this.containerMetrics.furthestCornerDistanceFrom(this.xStart,this.yStart);this.waveContainer.style.top=(this.containerMetrics.height-this.containerMetrics.size)/2+"px";this.waveContainer.style.left=(this.containerMetrics.width-this.containerMetrics.size)/2+"px";this.waveContainer.style.width=this.containerMetrics.size+"px";this.waveContainer.style.height=this.containerMetrics.size+"px"},/** @param {Event=} event */upAction:function upAction(event){if(!this.isMouseDown){return}this.mouseUpStart=Utility.now()},remove:function remove(){dom(this.waveContainer.parentNode).removeChild(this.waveContainer)}};/**
   ...
   @hero hero.svg
   @demo demo/index.html
   */Polymer({_template:html(_templateObject4_e7197e60ec2a11e9910517c323ef7a60()),is:"paper-ripple",behaviors:[IronA11yKeysBehavior],properties:{/**
...
if(this.hasRipple()&&1>this.getRipple().ripples.length){this._ripple.uiDownAction()}},/**
   ...
   */_buttonStateChanged:function _buttonStateChanged(){PaperRippleBehavior._buttonStateChanged.call(this);if(this.disabled){return}if(this.isAttached){this.checked=this.active}}};/** @polymerBehavior */_exports.PaperCheckedElementBehaviorImpl=PaperCheckedElementBehaviorImpl;var PaperCheckedElementBehavior=[PaperInkyFocusBehavior,IronCheckedElementBehavior,PaperCheckedElementBehaviorImpl];_exports.PaperCheckedElementBehavior=PaperCheckedElementBehavior;var paperCheckedElementBehavior={PaperCheckedElementBehaviorImpl:PaperCheckedElementBehaviorImpl,PaperCheckedElementBehavior:PaperCheckedElementBehavior};_exports.$paperCheckedElementBehavior=paperCheckedElementBehavior;var template$1=html(_templateObject5_e7197e60ec2a11e9910517c323ef7a60());template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);var template$2=html(_templateObject6_e7197e60ec2a11e9910517c323ef7a60());template$2.setAttribute("style","display: none;");document.head.appendChild(template$2.content);var template$3=html(_templateObject7_e7197e60ec2a11e9910517c323ef7a60());template$3.setAttribute("strip-whitespace","");/**
    ...
    */});var template$4=html(_templateObject8_e7197e60ec2a11e9910517c323ef7a60());template$4.setAttribute("style","display: none;");document.head.appendChild(template$4.content);var template$5=html(_templateObject9_e7197e60ec2a11e9910517c323ef7a60());template$5.setAttribute("style","display: none;");document.head.appendChild(template$5.content);var template$6=html(_templateObject10_e7197e60ec2a11e9910517c323ef7a60());template$6.setAttribute("strip-whitespace","");/**
                                                 Material design:
                                                 ...
                                                 element, make sure you've imported `paper-styles/typography.html`.
                                                                                               @demo demo/index.html
                                                 */Polymer({_template:template$6,is:"paper-checkbox",behaviors:[PaperCheckedElementBehavior],/** @private */hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{/**
...
_createRipple:function _createRipple(){this._rippleContainer=this.$.checkboxContainer;return PaperInkyFocusBehaviorImpl._createRipple.call(this)}});var PaperInputAddonBehavior={attached:function attached(){this.fire("addon-attached")},/**
...
this._focusableElement.focus()}}}};/** @polymerBehavior */_exports.PaperInputBehaviorImpl=PaperInputBehaviorImpl;var PaperInputBehavior=[IronControlState,IronA11yKeysBehavior,PaperInputBehaviorImpl];_exports.PaperInputBehavior=PaperInputBehavior;var paperInputBehavior={PaperInputHelper:PaperInputHelper,PaperInputBehaviorImpl:PaperInputBehaviorImpl,PaperInputBehavior:PaperInputBehavior};_exports.$paperInputBehavior=paperInputBehavior;var template$7=html(_templateObject11_e7197e60ec2a11e9910517c323ef7a60());template$7.setAttribute("style","display: none;");document.head.appendChild(template$7.content);Polymer({_template:html(_templateObject12_e7197e60ec2a11e9910517c323ef7a60()),is:"paper-input-char-counter",behaviors:[PaperInputAddonBehavior],properties:{_charCounterStr:{type:String,value:"0"}},/**
   ...
   */update:function update(state){if(!state.inputElement){return}state.value=state.value||"";var counter=state.value.toString().length.toString();if(state.inputElement.hasAttribute("maxlength")){counter+="/"+state.inputElement.getAttribute("maxlength")}this._charCounterStr=counter}});var template$8=html(_templateObject13_e7197e60ec2a11e9910517c323ef7a60());template$8.setAttribute("style","display: none;");document.head.appendChild(template$8.content);/*
                                               ...
                                               */Polymer({_template:html(_templateObject14_e7197e60ec2a11e9910517c323ef7a60()),is:"paper-input-container",properties:{/**
...
if(label){this.$.labelAndInputContainer.style.position="relative"}if(invalid){cls+=" is-invalid"}}}else{if(_inputHasContent){cls+=" label-is-hidden"}if(invalid){cls+=" is-invalid"}}if(focused){cls+=" focused"}return cls},/** @private */_computeUnderlineClass:function _computeUnderlineClass(focused,invalid){var cls="underline";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls},/** @private */_computeAddOnContentClass:function _computeAddOnContentClass(focused,invalid){var cls="add-on-content";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls}});Polymer({_template:html(_templateObject15_e7197e60ec2a11e9910517c323ef7a60()),is:"paper-input-error",behaviors:[PaperInputAddonBehavior],properties:{/**
   ...
   *     value: The input value.
   *     invalid: True if the input value is invalid.
   */update:function update(state){this._setInvalid(state.invalid)}});Polymer({is:"paper-input",_template:html(_templateObject16_e7197e60ec2a11e9910517c323ef7a60()),behaviors:[PaperInputBehavior,IronFormElementBehavior],properties:{value:{// Required for the correct TypeScript type-generation
type:String}},/**
...
for(var parent=node.parentNode,_strings=data.split(markerRegex),lastIndex=_strings.length-1,_i77=0;_i77<lastIndex;_i77++){parent.insertBefore(""===_strings[_i77]?createMarker():document.createTextNode(_strings[_i77]),node);_this41.parts.push({type:"node",index:++index})}// If there's no text, we must insert a comment to mark our place.
...
if(null===node.nextSibling){node.data=""}else{nodesToRemove.push(node);index--}partIndex++}else{var _i78=-1;while(-1!==(_i78=node.data.indexOf(marker,_i78+1))){// Comment node has a binding marker inside, make an inactive part
...
for(var _i79=0,_nodesToRemove=nodesToRemove,n;_i79<_nodesToRemove.length;_i79++){n=_nodesToRemove[_i79];n.parentNode.removeChild(n)}};_exports.Template$1=_exports.Template=Template;var isTemplatePartActive=function isTemplatePartActive(part){return-1!==part.index};// Allows `document.createComment('')` to be renamed for a
...
if(!isTemplatePartActive(_part8)){_this42._parts.push(void 0);partIndex++}else if(nodeIndex===_part8.index){if("node"===_part8.type){var _part9=_this42.processor.handleTextExpression(_this42.options);_part9.insertAfterNode(node.previousSibling);_this42._parts.push(_part9)}else{var _this42$_parts;(_this42$_parts=_this42._parts).push.apply(_this42$_parts,babelHelpers.toConsumableArray(_this42.processor.handleAttributeExpressions(node,_part8.name,_part8.strings,_this42.options)))}partIndex++}else{nodeIndex++;if("TEMPLATE"===node.nodeName){_prepareInstance(node.content)}node=walker.nextNode()}}};_prepareInstance(fragment);if(isCEPolyfill){document.adoptNode(fragment);customElements.upgrade(fragment)}return fragment}}]);return TemplateInstance}();_exports.TemplateInstance$1=_exports.TemplateInstance=TemplateInstance;var templateInstance={TemplateInstance:TemplateInstance};_exports.$templateInstance=templateInstance;var TemplateResult=/*#__PURE__*/function(){function TemplateResult(strings,values,type,processor){babelHelpers.classCallCheck(this,TemplateResult);this.strings=strings;this.values=values;this.type=type;this.processor=processor}/**
     ...
     */babelHelpers.createClass(TemplateResult,[{key:"getHTML",value:function getHTML(){for(var endIndex=this.strings.length-1,html="",_i80=0;_i80<endIndex;_i80++){var s=this.strings[_i80],match=lastAttributeNameRegex.exec(s);// This exec() call does two things:
...
html+=s+nodeMarker}}return html+this.strings[endIndex]}},{key:"getTemplateElement",value:function getTemplateElement(){var template=document.createElement("template");template.innerHTML=this.getHTML();return template}}]);return TemplateResult}();/**
   ...
   */_exports.TemplateResult$3=_exports.TemplateResult$2=_exports.TemplateResult$1=_exports.TemplateResult=TemplateResult;var SVGTemplateResult=/*#__PURE__*/function(_TemplateResult){babelHelpers.inherits(SVGTemplateResult,_TemplateResult);function SVGTemplateResult(){babelHelpers.classCallCheck(this,SVGTemplateResult);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SVGTemplateResult).apply(this,arguments))}babelHelpers.createClass(SVGTemplateResult,[{key:"getHTML",value:function getHTML(){return"<svg>".concat(babelHelpers.get(babelHelpers.getPrototypeOf(SVGTemplateResult.prototype),"getHTML",this).call(this),"</svg>")}},{key:"getTemplateElement",value:function getTemplateElement(){var template=babelHelpers.get(babelHelpers.getPrototypeOf(SVGTemplateResult.prototype),"getTemplateElement",this).call(this),content=template.content,svgElement=content.firstChild;content.removeChild(svgElement);reparentNodes(content,svgElement.firstChild);return template}}]);return SVGTemplateResult}(TemplateResult);_exports.SVGTemplateResult$2=_exports.SVGTemplateResult$1=_exports.SVGTemplateResult=SVGTemplateResult;var templateResult={TemplateResult:TemplateResult,SVGTemplateResult:SVGTemplateResult};_exports.$templateResult=templateResult;var isPrimitive=function isPrimitive(value){return null===value||!("object"===babelHelpers.typeof(value)||"function"===typeof value)};/**
    ...
    */_exports.isPrimitive$1=_exports.isPrimitive=isPrimitive;var AttributeCommitter=/*#__PURE__*/function(){function AttributeCommitter(element,name,strings){babelHelpers.classCallCheck(this,AttributeCommitter);this.dirty=!0;this.element=element;this.name=name;this.strings=strings;this.parts=[];for(var _i81=0;_i81<strings.length-1;_i81++){this.parts[_i81]=this._createPart()}}/**
     * Creates a single part. Override this to create a differnt type of part.
     */babelHelpers.createClass(AttributeCommitter,[{key:"_createPart",value:function _createPart(){return new AttributePart(this)}},{key:"_getValue",value:function _getValue(){for(var strings=this.strings,l=strings.length-1,text="",_i82=0;_i82<l;_i82++){text+=strings[_i82];var _part10=this.parts[_i82];if(_part10!==void 0){var v=_part10.value;if(null!=v&&(Array.isArray(v)||// tslint:disable-next-line:no-any
...
for(var condensedStyle=document.createElement("style"),_i84=0,_style7;_i84<styles.length;_i84++){_style7=styles[_i84];_style7.parentNode.removeChild(_style7);condensedStyle.textContent+=_style7.textContent}// Remove styles from nested templates in this scope.
...
styleSet.forEach(function(v){return styles.unshift(v)})}else if(userStyles){styles.push(userStyles)}return styles}}]);return LitElement}(UpdatingElement);_exports.LitElement=LitElement;/**
   ...
   */LitElement.finalized=!0;/**
                              ...
                              * @nocollapse
                              */LitElement.render=render$2;var litElement={LitElement:LitElement,defaultConverter:defaultConverter,notEqual:notEqual,UpdatingElement:UpdatingElement,customElement:customElement,property:property,query:query,queryAll:queryAll,eventOptions:eventOptions,html:html$1,svg:svg,TemplateResult:TemplateResult,SVGTemplateResult:SVGTemplateResult,supportsAdoptingStyleSheets:supportsAdoptingStyleSheets,CSSResult:CSSResult,unsafeCSS:unsafeCSS,css:css};_exports.$litElement=litElement;var ScoreTable=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(ScoreTable,_LitElement);babelHelpers.createClass(ScoreTable,[{key:"render",value:function render(){var _this47=this,rowArray=babelHelpers.toConsumableArray(Array(this.players)).map(function(v,i){return i}),names=["One","Two","Three","Four"];// Return the template.
return html$1(_templateObject17_e7197e60ec2a11e9910517c323ef7a60(),rowArray.map(function(i){return html$1(_templateObject18_e7197e60ec2a11e9910517c323ef7a60(),names[i])}),this.rowConfig.map(function(row){return html$1(_templateObject19_e7197e60ec2a11e9910517c323ef7a60(),row.icon,row.alt,rowArray.map(function(i){return html$1(_templateObject20_e7197e60ec2a11e9910517c323ef7a60(),i,_this47.__updateScore)}))}),rowArray.map(function(i){return html$1(_templateObject21_e7197e60ec2a11e9910517c323ef7a60(),_this47.totals[i])}))}},{key:"__updateScore",value:function __updateScore(event){var player=event.target.dataset.player,inputElements=this.shadowRoot.querySelectorAll("paper-input"),sum=0;inputElements.forEach(function(input){var partial=parseInt(input.value);if(partial&&input.dataset.player==player){sum+=parseInt(partial)}});this.totals[player]=sum;// lit-element does not do binding beyond top-level properties,
// so we manually request an update, which forces the totals to refresh.
this.requestUpdate()}}],[{key:"properties",get:function get(){return{rowConfig:{type:Array},players:{type:Number},totals:{type:Array}}}},{key:"styles",get:function get(){return[css(_templateObject22_e7197e60ec2a11e9910517c323ef7a60())]}}]);function ScoreTable(){var _this46;babelHelpers.classCallCheck(this,ScoreTable);_this46=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ScoreTable).call(this));_this46.rowConfig=[];_this46.players=4;_this46.totals=[];return _this46}return ScoreTable}(LitElement);window.customElements.define("score-table",ScoreTable);var SnackBar=/*#__PURE__*/function(_LitElement2){babelHelpers.inherits(SnackBar,_LitElement2);function SnackBar(){babelHelpers.classCallCheck(this,SnackBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SnackBar).apply(this,arguments))}babelHelpers.createClass(SnackBar,[{key:"render",value:function render(){return html$1(_templateObject23_e7197e60ec2a11e9910517c323ef7a60())}}],[{key:"properties",get:function get(){return{active:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject24_e7197e60ec2a11e9910517c323ef7a60())]}}]);return SnackBar}(LitElement);window.customElements.define("snack-bar",SnackBar);var UpdateNotifier=/*#__PURE__*/function(_LitElement3){babelHelpers.inherits(UpdateNotifier,_LitElement3);babelHelpers.createClass(UpdateNotifier,[{key:"render",value:function render(){return html$1(_templateObject25_e7197e60ec2a11e9910517c323ef7a60(),this._updateFound,this._reload)}}],[{key:"properties",get:function get(){return{_updateFound:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject26_e7197e60ec2a11e9910517c323ef7a60())]}}]);function UpdateNotifier(){var _this48;babelHelpers.classCallCheck(this,UpdateNotifier);_this48=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(UpdateNotifier).call(this));_this48._updateFound=!1;if("serviceWorker"in navigator){navigator.serviceWorker.getRegistration().then(function(registration){if(registration){registration.addEventListener("updatefound",function(){_this48._updateFound=!0})}})}return _this48}babelHelpers.createClass(UpdateNotifier,[{key:"_reload",value:function _reload(){window.location.reload()}}]);return UpdateNotifier}(LitElement);window.customElements.define("update-notifier",UpdateNotifier);var ElixerApp=/*#__PURE__*/function(_LitElement4){babelHelpers.inherits(ElixerApp,_LitElement4);babelHelpers.createClass(ElixerApp,[{key:"__storyIcons",value:function __storyIcons(number){var templates=[];for(;0<number;number--){templates.push(html$1(_templateObject27_e7197e60ec2a11e9910517c323ef7a60()))}return templates}},{key:"render",value:function render(){return html$1(_templateObject28_e7197e60ec2a11e9910517c323ef7a60(),this.__conf,this.__storyIcons(2),this.__storyIcons(3),this.__storyIcons(4),!this.__useNameOfTheWind,this.__onNameOfTheWindCheck,this.__a2hsOpen,this.__addToHomeScreen,this.__dismissA2HS)}},{key:"__onNameOfTheWindCheck",value:function __onNameOfTheWindCheck(event){if(event.target.checked){this.__conf=[].concat(babelHelpers.toConsumableArray(this.__conf),[this.__nameOfTheWind]);this.__useNameOfTheWind=!0}else{this.__conf=this.__conf.splice(0,this.__conf.length-1);this.__useNameOfTheWind=!1}}}],[{key:"properties",get:function get(){return{__conf:{type:Array},__nameOfTheWind:{type:Object},__useNameOfTheWind:{type:Boolean},__deferredPrompt:{type:Object},__a2hsOpen:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject29_e7197e60ec2a11e9910517c323ef7a60())]}}]);function ElixerApp(){var _this49;babelHelpers.classCallCheck(this,ElixerApp);_this49=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ElixerApp).call(this));_this49.__conf=[{icon:"triumph.png",alt:"Triumph icon"},{icon:"tragedy.png",alt:"Tragedy icon"},{icon:"hero.png",alt:"Hero Card icon"},{icon:"antihero.png",alt:"Antihero Card icon"},{icon:"experience.png",alt:"Experience Point icon"},{icon:"nature.png",alt:"Story Icon icon"}];_this49.__nameOfTheWind={icon:"name.png",alt:"Name icon"};_this49.__a2hsOpen=!1;return _this49}babelHelpers.createClass(ElixerApp,[{key:"firstUpdated",value:function firstUpdated(changedProperties){var _this50=this;babelHelpers.get(babelHelpers.getPrototypeOf(ElixerApp.prototype),"firstUpdated",this).call(this,changedProperties);window.addEventListener("beforeinstallprompt",function(e){// Prevent Chrome 76 and later from showing the mini-infobar
e.preventDefault();// Store the event so it can be triggered later.
_this50.__deferredPrompt=e;_this50.__a2hsOpen=!0})}},{key:"__addToHomeScreen",value:function __addToHomeScreen(){this.__a2hsOpen=!1;if(this.__deferredPrompt){this.__deferredPrompt.prompt();this.__deferredPrompt=null}}},{key:"__dismissA2HS",value:function __dismissA2HS(){this.__a2hsOpen=!1}}]);return ElixerApp}(LitElement);window.customElements.define("elixer-app",ElixerApp)});